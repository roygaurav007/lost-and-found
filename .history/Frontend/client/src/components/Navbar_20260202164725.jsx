...
import { Search, LogOut, UserCircle, ShieldCheck, LayoutDashboard } from 'lucide-react';
    ...
    <nav className="sticky top-0 z-50 bg-white/70 backdrop-blur-xl border-b border-slate-100 px-6 py-4">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          {/* 🛡️ Show Admin Panel ONLY for Admins */}
          {user?.role === 'admin' && (
          ...
          {/* 🎓 Show Student Hub ONLY for Users */}
          {user?.role === 'user' && (
          ...
          {user ? (
            <button onClick={onLogout} className="flex items-center gap-2 text-slate-600 font-bold hover:text-rose-500 transition">
