...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    navigate('/student-hub'); // Redirect to their new dashboard
  };

  return (
    <div className="max-w-md mx-auto mt-16 px-4">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-white p-10 rounded-[2.5rem] shadow-2xl border border-slate-50">
        <h2 className="text-3xl font-black text-center mb-2">Join the Hub</h2>
        <p className="text-slate-500 text-center mb-8 font-medium">Create your student account</p>
