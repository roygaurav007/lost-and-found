...
import { AuthProvider, useAuth } from './context/AuthContext'; // NEW: Pointing to current directory
  ...
  return (
    <Layout>
      ...
      <Routes>
        ...
        <Route path="*" element={<div className="py-20 text-center font-bold text-2xl">404: Not Found</div>} />
      </Routes>
    </Layout>
  );
}
