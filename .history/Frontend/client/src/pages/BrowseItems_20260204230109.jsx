...
const BrowseItems = () => {
  ...
  const handleClaimSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        toast.success("Claim filed! Admin will verify soon.");
  ...
  if (loading) return <div className="h-screen flex items-center justify-center font-black text-indigo-600 animate-pulse">SYNCING BOARD...</div>;
          ...
          <div className="flex gap-4 w-full md:w-auto">
            <div className="relative flex-grow md:w-80">
              ...
              <input 
                ...
                className="w-full p-4 pl-12 bg-white rounded-2xl shadow-sm border border-slate-200 outline-none focus:ring-2 focus:ring-indigo-500 font-bold transition-all"
              ...
              >
                ...
                <form onSubmit={handleClaimSubmit} className="space-y-4">
                  <textarea 
                    ...
                    className="w-full p-4 bg-slate-50 rounded-2xl outline-none border-2 border-transparent focus:border-indigo-500 focus:bg-white transition-all h-32 font-bold text-slate-900 resize-none" 
                    required
