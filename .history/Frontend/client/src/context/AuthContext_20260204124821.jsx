...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    toast.success("Welcome to the Student Hub!");
  ...
  return (
    <div className="max-w-md mx-auto mt-16 px-4">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} 
        ...
        <h2 className="text-3xl font-black text-center mb-8">Join FindIt</h2>
        ...
        <p className="mt-8 text-center text-slate-500 font-bold">
          Joined already? <Link to="/login" className="text-indigo-600 hover:underline">Sign In</Link>
        </p>
      </motion.div>
    </div>
  );
