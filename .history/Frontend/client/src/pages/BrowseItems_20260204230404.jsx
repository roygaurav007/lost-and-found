...
import { MapPin, Search, Clock, ShieldCheck, X, Package } from 'lucide-react';
        ...
        <header className="flex flex-col md:flex-row justify-between items-end gap-6 text-left">
          ...
          <div className="relative w-full md:w-80">
            ...
            <input 
              ...
              className="w-full p-4 pl-12 bg-white rounded-2xl shadow-sm border border-slate-200 outline-none focus:ring-2 focus:ring-indigo-600 font-bold transition-all text-slate-900"
          ...
          {selectedItem && (
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/10 backdrop-blur-sm">
              ...
              >
                ...
                <p className="text-slate-500 mb-8 font-medium italic text-sm">Proof of ownership is required.</p>
